...
run_step "install" "dependency lock validation" bash -lc 'pnpm install --frozen-lockfile && pnpm --dir ui install --frozen-lockfile && pnpm --dir v3 install --frozen-lockfile'
run_validation_suites
