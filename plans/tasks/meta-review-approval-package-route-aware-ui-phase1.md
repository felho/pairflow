...
|---|---|---|---|
| approval metadata hianyzik | generic approval package copy | no error, compat fallback | P1 |
| route ismeretlen | generic approval package copy | no error, compat fallback | P1 |
| approval request mar nem pending a current roundon | nincs approval package context | canonical pending approval resolution preserved | P1 |
...
1. A jelenlegi operator fajas pont elsodlegesen a `human_gate_budget_exhausted` route; a tobbi route dedikalt copyja kesobbi follow-upban is jo lehet.
