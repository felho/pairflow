...
title: "Actor Runtime Interface Meta-Review Cached State Shape Physical Removal and Writer Cleanup (Phase E)"
...
# Task: Actor Runtime Interface Meta-Review Cached State Shape Physical Removal and Writer Cleanup (Phase E)
...
Szuntesse meg fizikailag a cached meta-review state shape-et es annak writer ownershipet ugy, hogy a `meta_review` state blokk csak a megmarado live authority/runtime/gate mezoket tartsa.
...
4. A fenti valtozasok regresszios tesztjei.

### Out of Scope

1. Current-round authority/runtime contract kialakitasa.
2. Approval source-of-truth transcriptre allitasa.
3. Status/list projection contract cleanupja.
4. Public CLI, skill, UI, docs vagy read-model torles.
...
2. Erintett contractok:
   ...
   - physical field-removal sequencing contract.
...
11. Sequencing note:
   - this task is the physical field-removal slice,
   - and must land only after `plans/tasks/actor-runtime-interface-meta-review-cached-current-round-authority-and-runtime-consumer-cutover-phaseE.md`,
   - `plans/tasks/actor-runtime-interface-meta-review-cached-approval-and-projection-consumer-cutover-phaseE.md`,
   - and `plans/tasks/actor-runtime-interface-meta-review-cached-cli-read-stack-removal-phaseE.md`.
...
| Writer cleanup | submit/live-run writers updateje | legacy cached mezok tovabbi irasa | upstream contractra epul | P1 | required-now |
...
| Upstream cutover taskok nem landoltak | implementation sequencing | throw | ne tekintsd ezt direct next tasknak | N/A | warn | P1 | required-now |
...
| must-use | `plans/tasks/actor-runtime-interface-meta-review-cached-cli-read-stack-removal-phaseE.md` | P1 | required-now |
