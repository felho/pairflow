...
task_tracker:
  ...
  - task_id: 4-docs-site-pages
    task_path: plans/tasks/4-docs-site-pages.md
...
| `4-docs-site-pages` | `plans/tasks/4-docs-site-pages.md` | Add static documentation source/build/publish workflow covering install, upgrade, version pinning, CLI basics, UI, skills, and release semantics. | `1-package-version`, `2c-commit-policy`, `3-release-automation` | Missing public onboarding/docs surface. | implementable |
