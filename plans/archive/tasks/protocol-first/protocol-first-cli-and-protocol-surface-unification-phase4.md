...
2. Impacted contracts:
   ...
   - retained `bubble meta-review submit` caller-compatibility inventory es removal-path contract a checked-in `plans/archive/tasks/protocol-first/protocol-first-cli-and-protocol-surface-unification-phase4-retained-submit-callers.md` artifacton keresztul,
...
9. `caller-compatibility inventory` = explicit required-now evidence, amely felsorolja a meg letezo runtime/scripted caller-eket, megindokolja, miert nem migralhatok Phase 4-ben, es rogzitett Phase 5 migration/removal pathot ad minden retained kivetelhez; ennek canonical checked-in home-ja ebben a taskban a `plans/archive/tasks/protocol-first/protocol-first-cli-and-protocol-surface-unification-phase4-retained-submit-callers.md`.
...
| must-use | checked-in `plans/archive/tasks/protocol-first/protocol-first-cli-and-protocol-surface-unification-phase4-retained-submit-callers.md` caller-compatibility inventory minden retained `bubble meta-review submit` kivetelhez, Phase 5 migration/removal pathokkal | P1 | required-now |
...
11. Ne fogadjunk el retained `bubble meta-review submit` exceptiont a checked-in `plans/archive/tasks/protocol-first/protocol-first-cli-and-protocol-surface-unification-phase4-retained-submit-callers.md` inventory nelkul, akkor sem, ha a narrativ indoklas egyebkent hiheto.
