...
task_tracker:
  ...
  - task_id: 4-remote-merge-rename
    task_path: plans/tasks/4-remote-merge-rename.md
...
| `4-remote-merge-rename` | `plans/tasks/4-remote-merge-rename.md` | Rename the retained remote merge contract module into a command-neutral shared location and update imports without behavior changes. | `2-merge-local-helpers` | True shared remote merge contract remains under a command-named directory. | implementable |
