...
export type EmitApprovalDecisionDependencies = InternalApprovalCommandDependencies;
...
export interface EmitApprovalDecisionQueuedReworkResult {
  mode: "queued";
  bubbleId: string;
  intentId: string;
  state: PersistedBubbleStateSnapshot;
...
export type EmitApprovalDecisionResult =
...
export interface EmitRequestReworkImmediateResult
  extends EmitApprovalDecisionImmediateResult {
  mode: "immediate";
}
