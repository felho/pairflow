...
} from "../flow/runConvergedFlowContract.js";

export const convergedPolicyGateId = "converged_policy";
export const convergedValidationGateId = "converged_validation";
...
>;
export type ResolvedConvergedValidationPassResult = Extract<
  ResolvedConvergedValidationResult,
  { outcome: "pass" | "warn" }
>;
export type ConvergedGateMetadata =
  | {
      kind: "policy";
...
export function resolvePolicyGateResult(
  result: GatePipelineResult<ConvergedGateMetadata>
...
export function createConvergedGateContext(round: number, gateId?: string): PairflowCommandErrorContext {
  return {
...
export function toConvergedBlockedGateError(input: {
...
export function requireValidationGateDecision(input: {
  flowInput: RunConvergedFlowInput;
  round: number;
  pipelineResult: GatePipelineResult<ConvergedGateMetadata>;
...
export async function runConvergedGatePipeline(input: {
  flowInput: RunConvergedFlowInput;
