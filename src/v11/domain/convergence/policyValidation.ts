...
interface StructuredPassFindingsClaim {
...
const previousReviewerPassMissingError =
...
const previousReviewerPassFindingsCountError =
...
function validatePreviousReviewerVerdict(
  input: ConvergencePolicyInput,
  errors: string[],
  diagnostics: string[]
): void {
...
function validateHumanQuestions(
  input: ConvergencePolicyInput,
  errors: string[]
): void {
