...
const { buildSharedUiReviewPolicyPatch } = await import(new URL("dist/v11/shared/reviewPolicy/updateBubbleReviewPolicy.js", baseUrl).href);
const { updateBubbleReviewPolicy } = await import(new URL("dist/v11/infrastructure/artifact/reviewPolicy/updateBubbleReviewPolicy.js", baseUrl).href);
