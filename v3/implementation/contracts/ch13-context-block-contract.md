...
for ALL TEN DECIDED-HERE markers: C2 key lane + grammar, C3
no-reserve, C6 any-binding, C8(c) strict flip, C8(e) hygiene lane,
C9 record-order, C11 pair-flattening + quoting, C14 both-roles, C16
act composition, C17 optional-on-raw shape):** all ten triage
...
optionality grain. K1–K4: no beyond-chapter architecture shape —
